...
namespace KR\SonataUserBundle\Tests\Security\RolesBuilder;

use PHPUnit\Framework\TestCase;
use KR\SonataUserBundle\Security\RolesBuilder\AdminRolesBuilderInterface;
use KR\SonataUserBundle\Security\RolesBuilder\ExpandableRolesBuilderInterface;
use KR\SonataUserBundle\Security\RolesBuilder\MatrixRolesBuilder;
